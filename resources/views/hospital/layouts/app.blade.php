@php
$authHospital = auth()->guard("hospital")->user();
@endphp
...
<body>
    <form action="{{ localUrl(route('hospital.logout')) }}" method="post" id="logout">
        @csrf
    </form>
    <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-modern main-content-boxed">
        ...
        <aside id="side-overlay">
            ...
            <div class="content-header content-header-fullrow">
                <div class="content-header-section align-parent">
                    ...
                    <div class="content-header-item">
                        <a class="img-link mr-5" href="{{ route('hospital.home') }}">
                            <img class="img-avatar img-avatar32" src="{{ $authHospital->logo }}" alt="">
                        </a>
                        <a class="align-middle link-effect text-primary-dark font-w600"
                            href="javascript:void(0)">{{ $authHospital->name }}</a>
                    </div>
                    <!-- END User Info -->
                </div>
            </div>
            ...
            <div class="content-side">
                @include('hospital.includes.sidebar.right')
            </div>
            <!-- END Side Content -->
        </aside>
        <!-- END Side Overlay -->
            ...
            <div class="sidebar-content">
                ...
                <div class="content-header content-header-fullrow px-15">
                    ...
                    <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                        ...
                        <!-- Logo -->
                        <div class="content-header-item">
                            <a class="link-effect font-w700" href="{{ route('hospital.home') }}">
                ...
                <div class="content-side content-side-full">
                    @include('hospital.includes.sidebar.left')
                </div>
                <!-- END Side Navigation -->
            </div>
            <!-- Sidebar Content -->
        ...
        <header id="page-header">
            ...
            <div class="content-header">
                ...
                <div class="content-header-section">
                    <!-- User Dropdown -->
                    @include('hospital.includes.maindropdown')
                    <!-- END User Dropdown -->

                    <!-- Notifications -->
                    @include('hospital.includes.notifications')
                    <!-- END Notifications -->
